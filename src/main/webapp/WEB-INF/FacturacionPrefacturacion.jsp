...
try {
	...
	List<Map<String, ?>> dataSource = (List<Map<String, ?>>) request.getAttribute("ListFactura");
	...
	String jrxmlFile = session.getServletContext().getRealPath("META-INF\\jrxml\\ReporteFactura2.jrxml");
