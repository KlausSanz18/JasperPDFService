...
try {
	...
	List<Map<String, ?>> dataSource = (List<Map<String, ?>>) request.getAttribute("ListTecnico");
...
// 	SE OBTIENE LA DIRECCION DEL REPORTE JASPER
	...
	String jrxmlFile = session.getServletContext().getRealPath("META-INF\\jrxml\\ReporteTecnico1.jrxml");
