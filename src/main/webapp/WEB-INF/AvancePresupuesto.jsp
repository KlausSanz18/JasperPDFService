...
try {
	...
	List<Map<String, ?>> dataSource = (List<Map<String, ?>>) request.getAttribute("listproyecciones");
	...
	//String jrxmlFile = "C:\\Users\\alexander.dionicio\\git\\Falconeye-CMI.V2\\WebContent\\META-INF\\jrxml\\ReporteProyecciones.jrxml";
