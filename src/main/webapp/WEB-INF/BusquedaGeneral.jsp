...
try {
	...
	List<Map<String, ?>> dataSource = (List<Map<String, ?>>) request.getAttribute("listConsulta");
	...
	String jrxmlFile = session.getServletContext().getRealPath("\\META-INF\\jrxml\\ReporteConsultas.jrxml");
