...
try {
	...
	List<Map<String, ?>> dataSource = (List<Map<String, ?>>) request.getAttribute("ListEconomico");
	...
	String jrxmlFile = session.getServletContext().getRealPath("META-INF\\jrxml\\ReporteEconomico1.jrxml");
